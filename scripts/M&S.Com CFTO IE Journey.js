/**
 * Checks if the "M&S.com - CFTO IE" journey is executing without errors
 *
...
/**********************************************************************************************
 * Step 1: Go to CFTO IE Home Page
 **********************************************************************************************/
then(function() {
	console.log("Home Page URL: http://mns-prod-ie-cfto-prod.eu-gb.mybluemix.net/");
	//console.log("Home Page URL: https://christmasfood.marksandspencer.com/");
    console.log(new Date() + '--> ' + 'Step 1: Invoking Home Page # Begin');

    $browser.get("http://mns-prod-ie-cfto-prod.eu-gb.mybluemix.net/").
    then(function() {
        ...
        then(function(body) {
            ...
            URL_STRING = "http://mns-prod-ie-cfto-prod.eu-gb.mybluemix.net/slots";
